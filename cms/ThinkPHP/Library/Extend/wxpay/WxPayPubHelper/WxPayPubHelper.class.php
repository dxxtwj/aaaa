...
class Common_util_pub
{
	...
	public function getSign($Obj)
	{
		...
		//签名步骤二：在string后加入KEY
//		$String = $String."&key=".WxPayConf_pub::KEY;//原来
		$String = $String."&key=".$GLOBALS['a1']['WP_WXSignKey'];//现在
...
//		curl_setopt($ch,CURLOPT_SSLCERT, WxPayConf_pub::SSLCERT_PATH);
		curl_setopt($ch,CURLOPT_SSLCERT, $GLOBALS['a1']['WP_SSLCERT_PATH']);
		//默认格式为PEM，可以注释
		curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
//		curl_setopt($ch,CURLOPT_SSLKEY, WxPayConf_pub::SSLKEY_PATH);
		curl_setopt($ch,CURLOPT_SSLKEY, $GLOBALS['a1']['WP_SSLKEY_PATH']);
		//post提交方式
		curl_setopt($ch,CURLOPT_POST, true);
		curl_setopt($ch,CURLOPT_POSTFIELDS,$xml);
		$data = curl_exec($ch);
...
//	   	$this->parameters["mch_id"] = WxPayConf_pub::MCHID;//商户号
	   	...
	   	$this->parameters["appid"] = $GLOBALS['a1']['WP_APPID'];//公众账号ID
	   	$this->parameters["mch_id"] = $GLOBALS['a1']['WP_WXMchId'];//商户号
...
//		$this->curl_timeout = WxPayConf_pub::CURL_TIMEOUT;
		$this->curl_timeout = $GLOBALS['a1']['WP_CURL_TIMEOUT'];
	}
...
//		   	$this->returnParameters["mch_id"] = WxPayConf_pub::MCHID;//商户号
			$this->returnParameters["appid"] = $GLOBALS['a1']['WP_APPID'];//公众账号ID
		   	$this->returnParameters["mch_id"] = $GLOBALS['a1']['WP_WXMchId'];//商户号
...
//		$urlObj["appid"] = WxPayConf_pub::APPID;
		$urlObj["appid"] = $GLOBALS['a1']['WP_APPID'];
...
//		$urlObj["secret"] = WxPayConf_pub::APPSECRET;
		$urlObj["appid"] = $GLOBALS['a1']['WP_APPID'];
		$urlObj["secret"] = $GLOBALS['a1']['WP_AppSecret'];
...
//		$jsApiObj["appId"] = WxPayConf_pub::APPID;
		$jsApiObj["appId"] = $GLOBALS['a1']['WP_APPID'];
		$timeStamp = time();
 ...
 * 微信支付方法
 */
public function wxPay($body, $out_trade_no, $total_fee) {
	$pub = new WxPayConf_pub();
	$pub->getSome();
    $jsApi = new JsApi_pub();
    if (!isset($_GET['code'])) {
