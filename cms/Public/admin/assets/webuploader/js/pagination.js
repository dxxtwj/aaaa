...
function initPagination(element){  
    ...
    if(isNeedPagination(Number(totalpage),onePageIsShow)){  
        var content = '<ul class="pagination"><li value="1" class="showPa"><a href="javascript:void(0);">首页</a></li><li value="0"><a href="javascript:void(0);">«上页</a></li>';  
        for(var i =1; i<=totalpage;i++){  
            content +='<li value="'+i+'"><a href="javascript:void(0);">'+i+'</a></li>'  
        }  
        content +='<li value="-1"><a href="javascript:void(0);">下页»</a></li><li value="'+totalpage+'" class="showPa"><a href="javascript:void(0);">尾页</a></li></ul>';  
