...
class VerifyLogic
{
    ...
    public static function sendSmsVerify($phone, $data, $templateCode="SMS_84415005", $signName ="尚瑞")
    {
        //此处需要替换成自己的AK信息
        $accessKeyId = "LTAIjA90mwujFyFy";//参考本文档步骤2
        $accessKeySecret = "T2MZrz5hszKRvB8npQaGpGXzBDly7D";//参考本文档步骤2
