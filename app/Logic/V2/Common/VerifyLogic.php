...
class VerifyLogic
{
    ...
    {
        \Config::set('mail.from', array('address' => 'bnwh_gz@163.com', 'name' => '笨鸟'));
        \Config::set('mail.username', 'bnwh_gz@163.com');
        \Config::set('mail.password', 'bnwh965188');
    }
    //验证、文章使用
    ...
    public static function sendSmsVerify($phone, $data,$signName ="笨鸟文化控股",$templateCode="SMS_116562118")
    {
        //此处需要替换成自己的AK信息
        $accessKeyId = "LTAIyME9LzxvRzAl";//参考本文档步骤2
        $accessKeySecret = "y19iPZJce0aTgUcZW6CbhGfQXHohcr";//参考本文档步骤2
        ...
        $request->setTemplateParam(json_encode(['code'=>"$data"]));/*模板变量，数字一定要转换为字符串*/
