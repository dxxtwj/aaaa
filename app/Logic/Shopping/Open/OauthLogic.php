<?php
namespace App\Logic\Shopping\Open;

use App\Logic\Exception;

use App\Logic\Shopping\Common\LoadDataLogic;
use App\Logic\V3\Open\Alipay\OpenAppAlipayLogic;
use App\Logic\V3\Open\Jd\OpenAppJdLogic;
use App\Logic\V3\Open\QqConnect\OpenQqConnectLogin;
...
class OauthLogic extends LoadDataLogic
{
    ...
    private function runWechatMini(){
        ...
        $data = $openAppWechatLogic->handleMiniByCode($this->query);
